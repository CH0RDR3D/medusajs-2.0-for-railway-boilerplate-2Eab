...
export default async function Checkout({
  ...
  return (
    <div className="content-container py-8 small:py-12">
      {/* 4-Step Checkout Progress Indicator: Personal Details → Delivery → Payment → Confirmation */}
      <CheckoutErrorBoundary fallback={null}>
        <CheckoutStepIndicator
          cart={cart}
          currentStep={(step as any) || "address"}
        />
      </CheckoutErrorBoundary>

      <div className="grid grid-cols-1 small:grid-cols-[1fr_416px] gap-x-12 gap-y-8">
        <CheckoutErrorBoundary
          fallback={
