...
export default function NavCategories({
  ...
  useEffect(() => {
    ...
    if (isCategoriesOpen || isCollectionsOpen) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="relative flex-shrink-0" ref={collectionsRef}>
        <button
          type="button"
          onClick={() => setIsCollectionsOpen(!isCollectionsOpen)}
          className={`
            inline-flex items-center gap-1 px-3 py-1 text-xs font-semibold rounded-md
            ...
            ${isCollectionsOpen ? "bg-black/5 dark:bg-white/8 text-[var(--text-primary)]" : ""}
          `}
          aria-haspopup="menu"
        ...
        >
          Collections
          <svg
            className={`w-3.5 h-3.5 transition-transform duration-200 ${isCollectionsOpen ? "rotate-180" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            strokeWidth={1.8}
        ...
        <div
          className={`
            ...
            bg-[var(--nav-bg)] shadow-lg backdrop-blur-md p-2 transition-all duration-150 z-50
            ${isCollectionsOpen 
      ...
      <div className="relative flex-shrink-0" ref={categoriesRef}>
        <button
          ...
          className={`
            ...
            hover:bg-black/5 dark:hover:bg-white/8 transition-all duration-150
            focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:outline-none
            ${isCategoriesOpen ? "bg-black/5 dark:bg-white/8 text-[var(--text-primary)]" : ""}
          `}
          aria-haspopup="menu"
