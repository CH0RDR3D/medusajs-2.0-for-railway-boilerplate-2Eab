    ...
    <div>
      ...
      >
        ...
        <div className="flex relative w-full min-w-[320px]">
          ...
          >
            <ListboxOptions
              className="absolute -bottom-[calc(100%-36px)] left-0 xsmall:left-auto xsmall:right-0 max-h-[442px] overflow-y-scroll z-[900] bg-[var(--bg-card)] border border-[var(--nav-border)] drop-shadow-md text-small-regular uppercase text-[var(--text-primary)] no-scrollbar rounded-rounded w-full"
              static
            >
              {options.map((o) => (
                <ListboxOption
                  key={o.code || "default"}
                  value={o}
                  className="py-2 hover:bg-[var(--bg-surface)] px-3 cursor-pointer flex items-center gap-x-2"
                >
                  {o.countryCode ? (
                    /* @ts-ignore */
                    <ReactCountryFlag
