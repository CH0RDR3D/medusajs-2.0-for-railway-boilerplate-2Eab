    ...
    <div className="py-12">
      <div className="content-container">
        <div className="grid grid-cols-1 small:grid-cols-[1fr_360px] gap-x-40">
          <div className="flex flex-col bg-[var(--surface-card)] border border-[var(--surface-border)] rounded-2xl p-6 gap-y-6">
            <div className="bg-[var(--surface-card)] flex items-start justify-between">
