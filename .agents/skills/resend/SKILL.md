---
name: resend
description: 'Use this skill when integrating Resend for sending transactional emails, marketing broadcasts, React Email templates, managing domains, audiences, webhooks, or debugging Resend API and SDK issues.'
argument-hint: 'Describe your Resend task, email type, template, or integration requirements'
user-invocable: true
